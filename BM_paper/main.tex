...
There is no \Lean definition for a stochastic process: we use a function \lstinline|X : (t : T) → Ω →| $E_t$ together with appropriate measurability conditions.
