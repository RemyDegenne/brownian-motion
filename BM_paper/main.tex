...
Before describing our formalization, we discuss how this project led to an interesting development of the random variable formalism in \mathlib. Most content about probability theory in the library is about measure theory. The library contains several notions related to random variables, such as independence, conditional distributions or sub-Gaussianity. However it remains quite cumbersome to deal with random variables only without ever going back to measure theory. This strongly constrasts with probability theory in paper maths, where we set a probability space at the beginning and then do all the reasoning on random variables.
...
First the Carathéodory and Kolmogorov Extension Theorems in Section~\ref{S:extension}, then Gaussian measures and characteristic functions in Section~\ref{S:gaussian}, and finally the the Kolmogorov-Chentsov Theorem in Section~\ref{S:continuity}.
...
\subsubsection{Stochastic processes and the Kolmogorov condition}
