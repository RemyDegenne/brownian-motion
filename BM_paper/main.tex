...
\begin{itemize}
\item $X_t$ has almost surely locally Hölder-continuous paths for any coefficient $\beta < \tfrac 12$.
...
We refer to the implementation using links, like \bmlink{Gaussian/BrownianMotion}{L490-L493}{ProbabilityTheory.IsGaussian}, which point either to \mathlib or to \href{https://github.com/RemyDegenne/brownian-motion}{our repository}.
