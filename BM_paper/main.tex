...
The goal of our contribution is a formalization of the proof of that theorem in {\tt Lean}. We are using \leanline{Lean4}\cite{moura2021lean} and its mathematical library \leanline{mathlib} \cite{mathlib2020lean}\footnote{All references to results in \leanline{mathlib} are accurate for commit {\tt 537e7f030d6df737d728c7c002fb1928f4615afa}, August 22, 2023.}.
