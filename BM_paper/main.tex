...
Being indistinguishable implies being a modification, which in turn implies equality of laws.

\todor{add somewhere that continuous modifications are indistinguishable under suitable hypotheses}
...
\todor{discussion: \cite{kratschmer2023kolmogorov} also apply it to manifolds}
...
\todor{this is the proof for a particular $\beta$, not for all $\beta$}
