...
\begin{definition}[\docs{MeasureTheory.charFun}]
  If $E$ is a Hilbert space, the \emph{characteristic function} of $\mu$ is the map $\psi_\mu : E \to \R$ defined by
...
\begin{definition}[\docs{ProbabilityTheory.covarianceBilin}]
  The \emph{covariance bilinear form} of a measure $\mu$ with finite second moment $\mathbf{E}_\mu[\Vert X \Vert^2]$ is the bilinear form $C_{\mu} : E \times E \to \R$ defined by
