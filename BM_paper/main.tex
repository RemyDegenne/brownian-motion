...
\todor{The Krätschmer paper also does not mention separability of $T$ for the second part of the theorem, but if I recall correctly it is implicitly used in the proof.}
