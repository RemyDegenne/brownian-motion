...
\begin{itemize}
  ...
  \item Before Thm 4.13: \\{\color{blue}We added more details to explain how we get to Kolmogorov extension theorem from what preceeds.}
  ...
  \item Section 5, condition for exponents: \\ {\color{blue} We added a remark at the end of the text to explain that the theorem actually gives Holderianity up to $(n-1)/(2n)$, so we do need the condition for all $n$.}
  \item Proposition 5.3: \\{\color{blue}We made the definition more explicit.}
  \item Lemma 5.4: \\{\color{blue}We added a clarifying remark.}
\end{itemize}
