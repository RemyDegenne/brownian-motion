...
\begin{proof}
  ...
  \leanok
Apply Lemma~\ref{lem:local_induction} using Lemma~\ref{lem:ClassDL.hasLocallyIntegrableSup}, Lemma~\ref{lem:isStable_hasLocallyIntegrableSup} and Lemma~\ref{lem:locally_isCadlag}.
\end{proof}
