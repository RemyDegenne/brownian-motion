...
Every (right continuous) martingale is a (right continuous) local martingale.
\end{lemma}
...
The class of right continuous martingales is stable. That is, if $M$ is a right continuous martingale and $\tau$ is a stopping time, then the stopped process $M^{\tau}\mathbb{I}_{\tau > 0}$ is also a right continuous martingale.
\end{lemma}
...
The class of right continuous submartingales is stable. That is, if $M$ is a right continuous submartingale and $\tau$ is a stopping time, then the stopped process $M^{\tau}\mathbb{I}_{\tau > 0}$ is also a right continuous submartingale.
\end{lemma}
