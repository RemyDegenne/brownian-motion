...
\begin{lemma}\label{lem:implies_locally}
  \uses{def:locally}
  \mathlibok
  \lean{ProbabilityTheory.Locally.of_prop}
...
\begin{lemma}\label{lem:isStable_locally}
  ...
  \mathlibok
  \lean{ProbabilityTheory.IsStable.locally}
...
\begin{lemma}\label{lem:locally_inter}
  \uses{def:locally, def:stable}
  \mathlibok
  \lean{ProbabilityTheory.IsStable.and}
...
\begin{lemma}\label{lem:locally_of_isPreLocalizingSequence}
  ...
  \mathlibok
  \lean{ProbabilityTheory.IsStable.locally_of_isPreLocalizingSequence}
...
\begin{lemma}\label{lem:locally_locally}
  \uses{def:locally, def:stable}
  \mathlibok
  \lean{ProbabilityTheory.IsStable.locally_locally_iff}
...
\begin{lemma}[Local implication from global implication]\label{lem:local_induction}
  \uses{def:locally, def:stable}
  \mathlibok
  \lean{ProbabilityTheory.IsStable.locally_induction}
Suppose that the filtration is right-continuous.
...
\begin{lemma}\label{lem:isStable_isStronglyProgressive}
  \uses{def:stable}
  \leanok
  \lean{ProbabilityTheory.isStable_isStronglyProgressive}
...
\begin{definition}[Integrable supremum]\label{def:HasIntegrableSup}
  \leanok
...
\begin{definition}[Locally integrable supremum]\label{def:locallyIntegrableSup}
...
\begin{lemma}\label{lem:ClassD.uniformIntegrable}
  \uses{def:classD}
  \leanok
  \lean{ProbabilityTheory.ClassD.uniformIntegrable'}
A stochastic process of class D is uniformly integrable.
\end{lemma}

\begin{proof}\leanok
  \uses{def:classD, lem:uniformIntegrableComp}
Use the Class D property with the constant stopping times $\tau_n = n$ for all $n$ and apply Lemma~\ref{lem:uniformIntegrableComp}.
\end{proof}


\begin{lemma}\label{lem:classDL_iff_norm}
  \uses{def:classDL}
  \leanok
  \lean{ProbabilityTheory.classDL_iff_norm}
A progressively measurable process is of class DL iff its norm is of class DL.
\end{lemma}

\begin{proof}\leanok
  \uses{def:classDL, lem:uniformIntegrableIffNorm}

\end{proof}


\begin{lemma}\label{lem:classD_of_uniformIntegrable_bounded_stoppingTime}
  \uses{def:classD}
  \leanok
  \lean{ProbabilityTheory.classD_of_uniformIntegrable_bounded_stoppingTime}
...
\begin{lemma}\label{lem:classD_iff_norm}
  \uses{def:classD}
  \leanok
  \lean{ProbabilityTheory.classD_iff_norm}
A progressively measurable process is of class D iff its norm is of class D.
\end{lemma}

\begin{proof}\leanok
  \uses{def:classD, lem:uniformIntegrableIffNorm, lem:classD_of_uniformIntegrable_bounded_stoppingTime}
...
\begin{proof}
  \leanok
  \uses{lem:optionalSamplingSubmartingale, lem:uniformIntegrable_of_tendsto_ae, lem:uniformIntegrableComp, lem:ClassD.uniformIntegrable}
...
Conversely, if $X$ is of class D, then it is uniformly integrable by Lemma~\ref{lem:ClassD.uniformIntegrable}.
\end{proof}
...
\begin{lemma}\label{lem:Martingale.classD_iff_uniformIntegrable}
  \uses{def:Martingale, def:classD, def:RightContinuous}
  \leanok
...
\begin{proof}\leanok
  \uses{lem:Submartingale.classD_iff_uniformIntegrable, lem:uniformIntegrableIffNorm, lem:classD_iff_norm, cor:Martingale.submartingale_norm}
Applying Lemma~\ref{lem:classD_iff_norm} and Lemma~\ref{lem:uniformIntegrableIffNorm}, it suffices to show the result for the norm of the martingale.
That norm is a nonnegative right-continuous submartingale by Lemma~\ref{cor:Martingale.submartingale_norm} so this follows from Lemma~\ref{lem:Submartingale.classD_iff_uniformIntegrable}.
\end{proof}
...
\begin{proof}\leanok
  \uses{lem:uniformIntegrableComp, lem:uniformIntegrableDominated, lem:isStable_isStronglyProgressive}
...
\begin{lemma}\label{lem:IsStronglyProgressive.hasStronglyMeasurableSup}
  \uses{def:IsStronglyProgressive}
  \leanok
  \lean{MeasureTheory.IsStronglyProgressive.hasStronglyMeasurableSupProcess}
...
\begin{proof}\leanok
  \uses{lem:Integrable.classDL, lem:locally_mono, lem:isStable_isStronglyProgressive}
Combine Lemma~\ref{lem:Integrable.classDL} and Lemma~\ref{lem:locally_mono}. Use Lemma~\ref{lem:isStable_isStronglyProgressive} to get progressive measurability of the stopped processes.
\end{proof}
...
\begin{proof}\leanok
  \uses{lem:isLocalizingSequence_leastGE, lem:sup_stoppedProcess_le,lem:IsStronglyProgressive.hasStronglyMeasurableSup}
