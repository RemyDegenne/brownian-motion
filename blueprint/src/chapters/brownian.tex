...
\begin{definition}[Brownian motion]\label{def:brownianMotion}
  \uses{thm:localized_holder_version, def:preBrownian, lem:isKolmogorovProcess_preBrownian, lem:hasBoundedCoveringNumberCover_nnreal, lem:IsKolmogorovProcess.IsLocalizedKolmogorovProcess}
  \notready
...
\begin{proof}
  \uses{lem:isGaussianProcess_of_version, lem:isGaussianProcess_preBrownian}
