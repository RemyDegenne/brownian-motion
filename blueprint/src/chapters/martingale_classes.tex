...
Let $M \in \mathcal{M} \cap \mathcal{A}$ be a martingale with integrable variation. Then the jump part $M^d$ is an adapted process with integrable variation. Let $M^d_m$ be the martingale part of the Doob decomposition of $M^d$. Then $M = M_0 + M^d_m$. Finally, the predictable part of the decomposition of $M^d$ is continuous.
\end{lemma}
