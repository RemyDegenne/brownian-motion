...
\begin{lemma}\label{lem:optionalSampling_discrete_submartingale}
  ...
  Let $X$ be a discrete time submartingale with respect to the filtration $\mathcal{F}$ taking values in a real Banach space which is also a partially ordered module. Let
  $\tau, \sigma$ be stopping times. Then, if $\tau$ is bounded, we have that almost surely,
