...
the upcrossing numbers on those two index sets are equal by applying Lemma~\ref{lem:upcrossings_monotonicity} twice. A careful choice of such an isomorphism allows to reduce the problem to the case of $\mathbb{N}$.
