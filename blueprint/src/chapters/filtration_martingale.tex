...
\begin{proof}
  ...
  \[P[\|Y\|^p \mathbb{I}_{S}]^{1/p} = P[\liminf_{k \to \infty} \|X_{t_{n_k}}\|^p \mathbb{I}_{S}]^{1/p} \le \liminf_{k \to \infty} P[\|X_{t_{n_k}}\|^p \mathbb{I}_{S}]^{1/p} \le \epsilon.\]
...
\begin{lemma}[Doob's maximal Inequality for countable]\label{lem:doob_countable}
  ...
  Then for every $M \in I$ and $\lambda > 0$ we have
  \begin{align*}
