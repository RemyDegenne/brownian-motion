...
\begin{proof}
Build an increasing sequence of $\mathbb{N}$-indexed subsets of $T$ whose union is $T$ and apply Doob's upcrossing lemma on each of these subsets (TODO: it's in Mathlib).
