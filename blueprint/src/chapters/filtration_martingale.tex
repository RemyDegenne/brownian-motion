...
Let $X : T \to \Omega \to \mathbb{R}$ be a stochastic process, and fix $t\in T$. Let $a < b$ be real numbers, write $A=$(-\infty,a]$ and $B=[b,\infty)$. For each $n \in \mathbb{N}$, we define recursively the stopping times:
\begin{align*}
  \tau_0(\omega) & = \inf T \: , \\
...
\begin{remark}[Upcrossings hitting assumption]\label{rem:upcrossings_equiv_assumption}
...
Take two index sets, $S$ and $T$, and $t\inS$.
