...
For all $n \in \mathbb{N}$, let $C_n$ a finite $\varepsilon_n$-cover of $J$ with $C_n \subseteq J$ for $\varepsilon_n = \varepsilon_0 2^{-n}$.
Let $k = \max \left\{ 0, \left\lceil 1 + \log_2\left(\frac{\varepsilon_0}{\inf_{s, t \in J; d_T(s,t)>0}d_T(s, t)}\right) \right\rceil \right\}$.
...
\begin{proof}
The natural number $k$ satisfies $\varepsilon_k = \varepsilon_0 2^{-k} < \inf_{s, t \in J; d_T(s,t)>0}d_T(s, t)$.
...
\begin{proof}
  \uses{lem:second_term_bound, lem:integral_sup_rpow_dist_cover_rescale, cor:scale_change_rpow, lem:lintegral_sup_eq_lintegral_sup_cover}
