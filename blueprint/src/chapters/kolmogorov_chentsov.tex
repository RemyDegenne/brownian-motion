...
\begin{lemma}\label{lem:cover_eq_of_lt_iInf_dist}
  \leanok
  \lean{ProbabilityTheory.cover_eq_of_lt_iInf_edist}
...
\begin{proof}
  \uses{lem:second_term_bound, lem:integral_sup_rpow_dist_cover_rescale, cor:scale_change_rpow, lem:cover_eq_of_lt_iInf_dist}
