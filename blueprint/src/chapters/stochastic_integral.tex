...
\begin{definition}[Quadratic variation]\label{def:quadraticVariation}
  \uses{def:IsLocalMartingale, thm:local_doobMeyer}
...
$[M]$ is defined as the predictable part of the Doob-Meyer decomposition of the sub-martingale $\Vert M \Vert^2$~.
\end{definition}
