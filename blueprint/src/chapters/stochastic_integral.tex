...
TODO: what does $\mathbb{P} \times d[M]$ mean there? For Lean, that would be a measure on the product sigma-algebra, but we want the measure on the predictable sigma-algebra.
Is it the restriction (\texttt{Measure.trim})? Or asked differently: is the predictable sigma-algebra a sub-sigma-algebra of the product sigma-algebra?
