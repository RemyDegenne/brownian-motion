...
This section is devoted to the proof of Choquet's capacitability theorem, which is a key ingredient in the proof of the debut theorem. The presentation follows \cite{bichteler2002stochastic} for the definition of analytic sets (that definitions changes a lot between sources) and for the general proof steps, and \cite{he2019semimartingale} and the PlanetMath website for many of the proofs of individual lemmas.
