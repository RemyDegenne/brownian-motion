...
\begin{lemma}\label{lem:semiRingOfSets_disjoint_of_union_finer}
  ...
  The above family of pairwise disjoint sets $B_j$ can be chosen
  so that they form a refinement of the family $A_k$, that is,
  for every $k$ and $j$,
...
\begin{lemma}
  ...
  For a semi-ring of sets $C$, the family of finite unions of elements of $C$ is a ring of sets.
\end{lemma}
...
\begin{proof}
  ...
  Both $F \cap F'$ and $F \setminus F'$ are in $\mathcal{F}_s \cup \mathcal{F}_{s'}$,
  that is, in $\mathcal{F}_{s \vee s'}$~.
  It is now clear that $A\cap B$ is the predictable rectangle, since
  \[
  A \cap B
  =
...
\begin{lemma}\label{lem:setRing_of_finiteUnions}
  ...
  then finite unions of elements of $C$ form a ring of sets.
\end{lemma}
