...
\begin{proof}
  ...
  % By Lemma~\ref{lem:upcrossing_simpleProcess_le}, for all $a < b$ in $\mathbb{R}$, the number of
  % upcrossings $U_t[a, b]$ of the interval $[a, b]$ before time $t$ in $S$ satisfies
  % \begin{align*}
  %   (b - a) U_t[a, b] \le (\mathbb{1}_A \bullet X)_t + \max\{a - X_t, 0\}
  %   \:,
  % \end{align*}
