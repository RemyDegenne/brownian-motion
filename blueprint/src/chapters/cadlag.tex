...
\begin{definition}\label{def:cadlag}
  \uses{def:RightContinuous}
  \leanok
  \lean{IsCadlag}
  A function is cadlag if it is right-continuous and has left limits everywhere.
\end{definition}
...
\begin{corollary}\label{cor:exists_caldag_modification}
  \uses{def:elemStochIntegral, def:modification, def:cadlag}
...
\begin{lemma}\label{lem:Submartingale.exists_cadlag_modification_of_rightContinuous}
  \uses{def:modification, def:Submartingale, def:cadlag}
...
\begin{theorem}\label{thm:Submartingale.exists_cadlag_modification_iff_rightContinuous}
  \uses{def:modification, def:Submartingale, def:rightContinuous, def:cadlag}
...
\begin{theorem}\label{thm:Martingale.exists_cadlag_modification}
  \uses{def:modification, def:Martingale, def:rightContinuous, def:cadlag}
...
\begin{lemma}\label{lem:exists_cadlag_mod_of_nonneg_submg}
  \uses{def:hasUsualConditions, def:Submartingale, def:cadlag}
  Let the filtered probability space satisfy the usual conditions.
...
\begin{lemma}\label{lem:exists_cadlag_mod_of_local_mg}
  \uses{def:hasUsualConditions, def:cadlag}
  Let the filtered probability space satisfy the usual conditions.
