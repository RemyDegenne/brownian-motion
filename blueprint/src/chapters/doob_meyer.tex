...
\begin{proof}\leanok
  \uses{def:Submartingale, lem:condExp_sub_nonneg, lem:predictablePart_succ}
...
\begin{align*}
  ...
  \: .
\end{align*}
The first equality comes from Lemma~\ref{lem:predictablePart_succ}. As $\mathbb{N}$ is countable, we deduce that almost surely, for all $n \in \mathbb{N}$, $A_{n+1} \ge A_n$.
