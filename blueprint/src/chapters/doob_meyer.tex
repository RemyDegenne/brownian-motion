...
\begin{lemma}\label{lem:IsLocalMartingale.local_doobMeyerClass}
  \uses{def:IsLocalMartingale, def:Doob_Meyer_class}
...
\begin{proof}
  \uses{lem:IsLocalMartingale.local_doobMeyerClass, thm:Doob_Meyer}
